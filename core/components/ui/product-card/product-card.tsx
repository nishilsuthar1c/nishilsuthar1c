...
import CustomizedDialogs from '../mui-modal/mui-modal';
import BigDesignModal from '../big-design-modal/big-design-modal';
import WishlistButtonClient from '~/components/custom-wislist-button';
import { WishlistForm } from '~/components/product-card/add-to-wishlist/form';
    ...
    <div className={cn('group relative flex flex-col overflow-visible', className)} {...props}>
      ...
      <div className={cn('flex flex-1 flex-col gap-1', Boolean(addToCart) && 'justify-end')}>
        ...
        <div className="flex flex-wrap items-end justify-between pt-1">
          ...
          {/* <QuickView addToCart={addToCart} id={id} name={name} image={image} price={price}></QuickView> */}
          {/* <CustomizedDialogs addToCart={addToCart} id={id} name={name} image={image} price={price}></CustomizedDialogs> */}
          <BigDesignModal addToCart={addToCart} id={id} name={name} image={image} price={price}></BigDesignModal>
            {/* <WishlistButtonClient productId={id}></WishlistButtonClient> */}
            <WishlistForm wishlistProductIds={wishlistProductIds} productId={id}></WishlistForm>
